...
import cloud.artik.client.auth.OAuth.AccessTokenListener;
import cloud.artik.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient(String[] authNames) {
        ...
        for(String authName : authNames) {
            Interceptor auth;
            if ("artikcloud_oauth".equals(authName)) {
                auth = new OAuth(OAuthFlow.implicit, "https://accounts.artik.cloud/authorize", "https://accounts.artik.cloud/token", "read:artikcloud, write:artikcloud");
            } else {
    ...
    public void createDefaultAdapter() {
        ...
        String baseUrl = "https://api.artik.cloud/v1.1";
        if(!baseUrl.endsWith("/"))
        	baseUrl = baseUrl + "/";
