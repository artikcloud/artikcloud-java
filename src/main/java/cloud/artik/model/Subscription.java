...
public class Subscription {
  ...
  @SerializedName("includeSharedDevices")
  private Boolean includeSharedDevices = null;
  ...
  public Subscription awsRegion(String awsRegion) {
  ...
  **/
  ...
  public Subscription includeSharedDevices(Boolean includeSharedDevices) {
    this.includeSharedDevices = includeSharedDevices;
    return this;
  }

   /**
   * Include Shared Devices
   * @return includeSharedDevices
  **/
  @ApiModelProperty(example = "null", value = "Include Shared Devices")
  public Boolean getIncludeSharedDevices() {
    return includeSharedDevices;
  }

  public void setIncludeSharedDevices(Boolean includeSharedDevices) {
    this.includeSharedDevices = includeSharedDevices;
  }
  ...
  **/
  ...
  public Subscription awsKey(String awsKey) {
    this.awsKey = awsKey;
    return this;
  }
  ...
  **/
  ...
  public Subscription awsSecret(String awsSecret) {
  ...
  **/
  ...
  public Subscription createdOn(Long createdOn) {
  ...
  **/
  ...
  public Subscription awsKinesisStreamName(String awsKinesisStreamName) {
  ...
  **/
  ...
  public Subscription uid(String uid) {
    this.uid = uid;
    return this;
  }
  ...
  **/
  ...
  public Subscription messageType(String messageType) {
  ...
  **/
  ...
  public Subscription ddid(String ddid) {
    this.ddid = ddid;
    return this;
  }
  ...
  **/
  ...
  public Subscription sdid(String sdid) {
    this.sdid = sdid;
    return this;
  }
  ...
  **/
  ...
  public Subscription aid(String aid) {
    this.aid = aid;
    return this;
  }
  ...
  **/
  ...
  public Subscription sdtid(String sdtid) {
    this.sdtid = sdtid;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.awsRegion, subscription.awsRegion) &&
        Objects.equals(this.includeSharedDevices, subscription.includeSharedDevices) &&
        Objects.equals(this.description, subscription.description) &&
        Objects.equals(this.awsKey, subscription.awsKey) &&
        Objects.equals(this.awsSecret, subscription.awsSecret) &&
        Objects.equals(this.createdOn, subscription.createdOn) &&
        Objects.equals(this.awsKinesisStreamName, subscription.awsKinesisStreamName) &&
        Objects.equals(this.uid, subscription.uid) &&
        Objects.equals(this.messageType, subscription.messageType) &&
        Objects.equals(this.ddid, subscription.ddid) &&
        Objects.equals(this.subscriptionType, subscription.subscriptionType) &&
        Objects.equals(this.name, subscription.name) &&
        Objects.equals(this.sdid, subscription.sdid) &&
        Objects.equals(this.callbackUrl, subscription.callbackUrl) &&
        Objects.equals(this.id, subscription.id) &&
        Objects.equals(this.aid, subscription.aid) &&
        Objects.equals(this.sdtid, subscription.sdtid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(awsRegion, includeSharedDevices, description, awsKey, awsSecret, createdOn, awsKinesisStreamName, uid, messageType, ddid, subscriptionType, name, sdid, callbackUrl, id, aid, sdtid);
  }
  ...
  public String toString() {
    ...
    sb.append("    includeSharedDevices: ").append(toIndentedString(includeSharedDevices)).append("\n");
