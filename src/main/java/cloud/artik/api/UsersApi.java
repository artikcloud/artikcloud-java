...
public class UsersApi {
  ...
  private Call getUserRulesCall(String userId, Boolean excludeDisabled, Boolean otherApplications, Integer count, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    Object localVarPostBody = null;
    ...
    if (otherApplications != null)
      localVarQueryParams.addAll(apiClient.parameterToPairs("", "otherApplications", otherApplications));
    if (count != null)
      localVarQueryParams.addAll(apiClient.parameterToPairs("", "count", count));
    if (offset != null)
      localVarQueryParams.addAll(apiClient.parameterToPairs("", "offset", offset));
   ...
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
   */
  public RulesEnvelope getUserRules(String userId, Boolean excludeDisabled, Boolean otherApplications, Integer count, Integer offset) throws ApiException {
    ApiResponse<RulesEnvelope> resp = getUserRulesWithHttpInfo(userId, excludeDisabled, otherApplications, count, offset);
    return resp.getData();
  }
   ...
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
   */
  public ApiResponse<RulesEnvelope> getUserRulesWithHttpInfo(String userId, Boolean excludeDisabled, Boolean otherApplications, Integer count, Integer offset) throws ApiException {
    Call call = getUserRulesCall(userId, excludeDisabled, otherApplications, count, offset, null, null);
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call getUserRulesAsync(String userId, Boolean excludeDisabled, Boolean otherApplications, Integer count, Integer offset, final ApiCallback<RulesEnvelope> callback) throws ApiException {
    ...
    Call call = getUserRulesCall(userId, excludeDisabled, otherApplications, count, offset, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<RulesEnvelope>(){}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
